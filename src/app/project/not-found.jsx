...
export default function NotFound() {
	return (
		<div className="container mx-auto h-dvh flex items-center justify-center flex-col gap-6 text-white px-4 pt-20">
			...
			<h1 className="text-accent text-center text-3xl sm:text-5xl font-extrabold">404 | Project Not Found</h1>

			<p className="text-muted text-center max-w-md text-sm sm:text-base">
				The project you&apos;re looking for doesn&apos;t exist, may have been removed, or the URL is incorrect.
			</p>
