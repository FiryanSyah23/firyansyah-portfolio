			...
			<div className="container mx-auto px-4 ">
				<div className="grid lg:grid-cols-2 grid-cols-1  text-white">
					<div className="main-header title flex justify-center lg:text-start text-center flex-col gap-3  ">
						<h1 className="max-sm:text-2xl sm:text-4xl md:text-2xl xl:text-4xl font-bold">Hello I&apos;m Firyan Syah</h1>
						<p className="max-sm:text-5xl/tight sm:text-7xl md:text-6xl xl:text-8xl tracking-tight">
							Let&apos;s <span className="text-accent font-bold">Bring</span> <br /> Your <span className="text-accent font-bold">Ideas</span> to Life.
						</p>
						<p className="md:text-base/relaxed sm:text-base/relaxed max-sm:text-sm/relaxed xl:text-lg/relaxed text-muted mt-2 ">
