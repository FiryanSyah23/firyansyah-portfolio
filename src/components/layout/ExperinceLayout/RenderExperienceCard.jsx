...
export default function RenderExperienceCard() {
	return (
		<div className="expe-main  flex justify-center lg:gap-20 gap-5 mt-20 flex-wrap ">
			{dataExperience.map((item, index) => (
				<div
					key={index}
					className=" w-85 flex flex-col items-center  gap-3  text-center bg-panel p-5 text-white rounded-xl shadow-[0px_0px_2px_1px_#ffffff] "
				>
